...
- [Desktop period calculations](../clients/desktop/usage.cpp)
- [Desktop warning policy](../clients/desktop/warning.cpp)
- [Desktop controller](../clients/desktop/controller.cpp)
- [Desktop tray model and rendering](../clients/desktop/trayvisual.cpp)
- [Desktop startup service](../clients/desktop/startup.cpp)
- [Desktop version and release checks](../clients/desktop/appinfo.cpp)
