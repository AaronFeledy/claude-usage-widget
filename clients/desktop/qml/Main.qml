...
ApplicationWindow {
    id: window
    width: 1180; height: 940; minimumWidth: 420; minimumHeight: 580
    visible: !startHidden
    title: "Headroom"
    ...
    ColumnLayout {
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        Repeater { model: window.shownProviders; ProviderCard { required property var modelData; provider: modelData; Layout.fillWidth: true } }
                    }
                    Rectangle {
                        visible: window.providers.length === 0
        ...
        Rectangle {
            ...
            color: Theme.inset
            Rectangle { anchors.top: parent.top; width: parent.width; height: 1; color: Theme.selection }
            ColumnLayout {
                id: footerBody
